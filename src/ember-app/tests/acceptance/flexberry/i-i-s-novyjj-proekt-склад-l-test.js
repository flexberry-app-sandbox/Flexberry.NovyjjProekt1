...
moduleForAcceptance('[AGAT] Acceptance | i i s novyjj proekt склад l');

test('testing i-i-s-novyjj-proekt-склад-l', function(assert) {
  visit('/i-i-s-novyjj-proekt-склад-l');
