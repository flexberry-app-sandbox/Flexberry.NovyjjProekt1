...
moduleForAcceptance('[AGAT] Acceptance | i i s novyjj proekt товар l');

test('testing i-i-s-novyjj-proekt-товар-l', function(assert) {
  visit('/i-i-s-novyjj-proekt-товар-l');
