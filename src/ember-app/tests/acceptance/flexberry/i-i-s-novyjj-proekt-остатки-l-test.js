...
moduleForAcceptance('[AGAT] Acceptance | i i s novyjj proekt остатки l');

test('testing i-i-s-novyjj-proekt-остатки-l', function(assert) {
  visit('/i-i-s-novyjj-proekt-остатки-l');
